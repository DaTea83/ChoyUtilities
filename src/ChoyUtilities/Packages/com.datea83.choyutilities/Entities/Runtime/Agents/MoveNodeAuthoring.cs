    ...
    public class MoveNodeAuthoring : MonoBehaviour {
        ...
        private class Baker : Baker<MoveNodeAuthoring> {
            ...
            public override void Bake(MoveNodeAuthoring authoring) {
                ...
                foreach (var c in authoring.connections) {
                    ...
                    buffer.Add(new ConnectedNodeIBuffer
...
#if UNITY_EDITOR
        [Header("Gizmos")] [SerializeField] private Color connectionColor = Color.yellow;
        ...
        private void OnDrawGizmos() {
            ...
            foreach (var c in connections) {
                ...
                var right = math.mul(
                    math.mul(quaternion.LookRotation(dir, math.up()), quaternion.Euler(0, math.radians(150), 0)),
                    math.forward());
